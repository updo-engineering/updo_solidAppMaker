...
export const newUser = async (countryCode,phone,login_source,email,auth_token,user_type,name,profile_pic,fcm_token,os) =>api.post('common/new_user', {login_source:login_source,country_code: countryCode,phone: phone,email:email,auth_token:auth_token,user_type:user_type,name:name,profile_pic:profile_pic,fcm_token:fcm_token,os:os});
...
export const updateCustomer = async (os,fcm_token,profile_pic,name,about_me,images,address,gender,age,ethnicity,childrens,emp_status,education,token,refferal_code,dob) =>api.post('customers/update', {os,fcm_token,profile_pic,name,about_me,images,address,gender,age,ethnicity,childrens,emp_status,education,refferal_code,dob},{ headers: { 'Authorization': 'Bearer '+token }});
export const updateProvider = async (os,fcm_token,profile_pic,name,about_me,images,address,services,availability,email,events,note,social_links,gender,age,ethnicity,languages,emp_status,education,token,refferal_code,dob,license,any_event,practice_years,status) =>api.post('providers/update', { os,fcm_token,profile_pic,name,about_me,images,address,services,availability,events,email,note,social_links,gender,age,ethnicity,languages,emp_status,education,token,refferal_code,dob,license,any_event,practice_years,status},{ headers: { 'Authorization': 'Bearer '+token }});
export const updateUser = async (profile_pic,name,about_me,images,address,token,dob) =>api.post('customers/update', {profile_pic,name,about_me,images,address,dob},{ headers: { 'Authorization': 'Bearer '+token }});
export const updateServiceProvider = async (profile_pic,name,about_me,images,address,token,dob,social_links,services,events,availability) =>api.post('providers/update', {profile_pic,name,about_me,images,address,dob,social_links,services,events,availability},{ headers: { 'Authorization': 'Bearer '+token }});
export const updatePopupVisibility = async (token,isCustomer,is_popup_view) =>api.post(isCustomer ? 'customers/update' :'providers/update', {is_popup_view},{ headers: { 'Authorization': 'Bearer '+token }});
...
export const updateFcm = async (isCustomer,fcm_token,token) =>api.post(isCustomer ? 'customers/update' :'providers/update', {fcm_token},{ headers: { 'Authorization': 'Bearer '+token }});
...
export const getLastAppointmentDetail = async (customer_id,token) =>api.post('providers/get_last_appointment', {customer_id},{ headers: { 'Authorization': 'Bearer '+token }});
