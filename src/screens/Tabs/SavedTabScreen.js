    ...
    return (
        auth ?
            <View style={{ backgroundColor: "white", height: "100%" }}>
                ...
                </SafeAreaView></View> : < SignInForDetailScreen title="Saved" descrip="Sign in and start planning your Tiptop: As you search, tap the hear icon to save your favorite Tiptoppers and services. " />
    )
}
